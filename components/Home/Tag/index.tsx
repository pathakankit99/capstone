const index = () => {
    return (
      <div className="absolute z-50 -mt-36 w-full p-6">
        <div className="center h-64">
          <div className="hover-scale relative h-full w-full overflow-hidden bg-blue-500 lg:w-6/12">
            <img className="relative" src="/images/tag-1.jpg" />
          ...
          <div className="relative hover-scale h-full w-full overflow-hidden bg-brand_red lg:w-4/12">
            <img className="relative" src="/images/tag-2.jpg" />
            <div className="absolute top-0 bottom-0 left-0 right-0 p-10">
          ...
          <div className="hover-scale relative h-full w-full overflow-hidden bg-white text-brand_gray lg:w-2/12">
            <img className="relative" src="/images/chef-hat.jpg" />
